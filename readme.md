...
## 1.1.5 2020年8月6日
【新增：组合查询财务记录接口；查询用户结算记录接口；组合查询合约历史委托接口；组合查询历史成交记录接口；订阅计划委托订单更新接口】
...
## 1.0.7 2020年8月6日 【新增：买一卖一逐笔行情 WS
接口；查询用户可用杠杆倍数；组合查询财务记录接口；查询用户结算记录接口；组合查询合约历史委托接口；组合查询历史成交记录接口；订阅计划委托订单更新接口】
