...
### Q29: 获取用户账户信息（/api/v1/contract_account_info）中的risk_rate
...
### Q24: 获取K线数据(swap-ex/market/history/kline)时, from 和 to 的时间间隔是 2000 *
...
### Q29: 获取用户账户信息（swap-api/v1/swap_account_info）中的risk_rate
"保证金率”和WEB端的"担保资产率”是一样的吗?
