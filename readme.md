...
火币合约 API 直连专线解决方案是基于 AWS 基础架构构建的。客户端将通过 AWS “PrivateLink”进行连接，通过快速的 AWS
...
火币合约实行阶梯强平机制，即系统会尝试降低调整系数对应的档位，从而避免仓位被一次性强平。  
...
[Read the full documentation](https://help.github.com/pages/) for more
information about using **GitHub Pages**.
